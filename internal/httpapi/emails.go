...
// preview is best-effort: if the archived .eml can't be read (e.g. it's
// only in S3, once Phase 3 exists, or was somehow removed from disk),
...
// that's still known about the email.
